    ...
    return(
        ...
        <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="addOptionModalLabel">Add New Course</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mb-3">
                                <div class="form-floating">
                                    <select class="form-select" id="EducationType" placeholder="Select Option"/>
                                    <label for="LevelType"><i class="fas fa-info-circle me-2"></i>Option</label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-floating">
